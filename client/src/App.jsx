...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-gray-100 flex flex-col justify-between">
      ...
      <footer className="mt-12 py-8 border-t border-gray-800/80 text-center px-4 flex flex-col items-center gap-4">
  {/* BACK TO TOP BUTTON */}
  <button
    onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}
    className="w-10 h-10 rounded-full bg-gray-900 hover:bg-gray-800 active:bg-gray-700 border border-gray-800 flex items-center justify-center text-gray-400 hover:text-white transition-all shadow-sm"
  ...
  <p className="text-xs text-gray-400 font-medium">
    Built with 💪 by{' '}
    <a
      href="https://khallidium.vercel.app"
      target="_blank"
      rel="noopener noreferrer"
      className="text-blue-400 hover:text-blue-300 font-bold underline decoration-blue-500/40 underline-offset-4 transition-colors"
    >
      Khallidium
    </a>
  </p>
